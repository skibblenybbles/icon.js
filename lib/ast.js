...
var //---------------
    ...
    // evaluated before the test expression is evaluated on the next round.
    ...
    // expressions into the function's arguments.
    ...
    // An operator reduces a native binary operator on the values of an
    // arbitrary number of evaluated expressions.
    ...
    // A short-circuiting operator reduces a native binary operator on the
    // values of an arbitrary number of evaluated expressions until an
    // expression evaluates to a specific value, at which point the reduction
    // short-circuits.
